...
// Buat objek mobil3 dari kelas Mobil
const mobil3 = new Mobil("Avanza", 2020);

// Buat objek mobil4 dari kelas Mobil
...
document.getElementById("mobil3").innerHTML += `<p>${mobil3.infoMobil()}</p>`;
document.getElementById("mobil4").innerHTML += `<p>${mobil4.infoMobil()}</p>`;